...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference("Exam.count") do
      post exams_url, params: { exam: { grade: @exam.grade, overview: @exam.overview, student_id: @exam.student_id, subject: @exam.subject, term: @exam.term, year: @exam.year } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { grade: @exam.grade, overview: @exam.overview, student_id: @exam.student_id, subject: @exam.subject, term: @exam.term, year: @exam.year } }
